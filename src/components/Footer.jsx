        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <p className="text-xs text-slate-400 leading-relaxed max-w-sm">
              Wholesale trading establishment supplying slaughterhouse & food plant hygiene gear, industrial dangri boiler suits, waterproof gumboots, cattle ear tags with applicators & cutters, and genuine Meena brand knifes to enterprises across India.
            </p>
