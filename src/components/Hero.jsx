              ...
              <div className="space-y-3.5 text-sm">
                ...
                <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    ...
                    <span className="text-[11px] bg-slate-800 text-amber-400 font-bold px-2 py-0.5 rounded border border-amber-400/30">Meena Brand Knives</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16 pt-12 border-t border-slate-800/80">
          ...
          <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-900/40 border border-slate-800/60">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">Hallmarked butcher & skinning knives</p>
            </div>
          </div>
        </div>
